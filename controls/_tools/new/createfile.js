...
var text = System.IO.File.ReadAllText(root + "_tpl/index.html");
...
System.IO.File.Copy(root + "_tpl/assets/styles/index.css", root + mainModuleName + "/assets/styles/" + subModuleName + ".css");
System.IO.File.Copy(root + "_tpl/assets/scripts/index.js", root + mainModuleName + "/assets/scripts/" + subModuleName + ".js");
Console.Write("完成");